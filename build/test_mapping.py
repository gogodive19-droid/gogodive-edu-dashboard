...
CASES = {
    ...
    "(용입 딥스) 중급/마스터 연습반": ("연습반", "중급/마스터 연습반", "용인 딥스테이션"),
    ...
    "(용인 딥스) (마스터 부이 연습반)": ("연습반", "마스터 부이 연습반", "용인 딥스테이션"),
    ...
    "(코칭반) 시흥 파라다이브": ("딥풀 코칭반", "딥풀 코칭반", "시흥 파라다이브"),
    "(코칭반) 용인 딥스테이션": ("딥풀 코칭반", "딥풀 코칭반", "용인 딥스테이션"),
    "(가평 K26) 코칭반": ("딥풀 코칭반", "딥풀 코칭반", "가평 K26"),
    "(대학생 | 코칭반) 잠실 올림픽공원": ("대학생", "대학생 코칭반", "잠실 올림픽공원"),
    "(연습반) 오산 TSN 오산입니다": ("연습반", "연습반", "오산 TSN"),
    "(연습반) 잠실 올림픽공원**": ("연습반", "연습반", "잠실 올림픽공원"),
...
def test_full_files():
    ...
    if len(raw) == 31318:
        ...
        # 코칭반 4208 - 중복 1 = 4207 → 딥풀(용인·시흥·가평) 1520 + 일반 2687
        assert bigs["딥풀 코칭반"] == 1520, bigs["딥풀 코칭반"]
        assert bigs["코칭반"] == 2687, bigs["코칭반"]
